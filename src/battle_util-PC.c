        ...
        && GetBattlerSide(gBattlerAttacker) != GetBattlerSide(gSideTimers[side].followmeTarget))
    {
        gBattleStruct->moveTarget[gBattlerAttacker] = gBattlerTarget = gSideTimers[side].followmeTarget; // follow me moxie fix
           ...
           && ((GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != ABILITY_LIGHTNING_ROD && moveType == TYPE_ELECTRIC)
            || (GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != (ABILITY_STORM_DRAIN || ABILITY_VAPORIZE) && moveType == TYPE_WATER)))
    {
        ...
        for (battler = 0; battler < gBattlersCount; battler++)
        {
            if (side != GetBattlerSide(battler)
                ...
                && ((GetBattlerAbility(battler) == ABILITY_LIGHTNING_ROD && moveType == TYPE_ELECTRIC)
                 || (GetBattlerAbility(battler) == (ABILITY_STORM_DRAIN || ABILITY_VAPORIZE) && moveType == TYPE_WATER))
        ...
        else
        {
            ...
            else if (battlerAbility == ABILITY_VAPORIZE)
                gSpecialStatuses[battler].vaporizeStopsWater = TRUE;
...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic ice     dragon  dark    fairy
    ...
    {X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(0.5), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0)}, // poison
    ...
    {X(1.0), X(1.0), X(0.5), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(0.5), X(1.0), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(2.0), X(1.0)}, // bug
    ...
    {X(1.0), X(1.0), X(1.0), X(0.5), X(2.0), X(2.0), X(0.5), X(1.0), X(0.5), X(1.0), X(0.5), X(2.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0)}, // grass
    {X(1.0), X(1.0), X(2.0), X(1.0), X(0.0), X(0.5), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(2.0), X(0.5), X(0.5), X(1.0), X(0.5), X(0.5), X(1.0), X(1.0)}, // electric
    ...
    #endif
    {X(0.5), X(2.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(2.0), X(1.0)}, // fairy
};
...
u32 GetMoveTarget(u16 move, u8 setTarget)
{
    ...
    case MOVE_TARGET_SELECTED:
        ...
        else
        {
            ...
            {
                if(IsAbilityOnOpposingSide(gBattlerAttacker, ABILITY_VAPORIZE)
                && GetBattlerAbility(targetBattler) != ABILITY_VAPORIZE)
                {
                    targetBattler ^= BIT_FLANK;
                    RecordAbilityBattle(targetBattler, gBattleMons[targetBattler].ability);
                    gSpecialStatuses[targetBattler].vaporizeStopsWater = TRUE;
                }
                else if (IsAbilityOnOpposingSide(gBattlerAttacker, ABILITY_STORM_DRAIN)
...
bool32 IsBattlerProtected(u32 battler, u32 move)
{
    ...
    // Truant pokemon are able to hit through all protection effects
