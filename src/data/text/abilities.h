...
static const u8 sMegaLauncherDescription[] = _("Boosts pulse & cannon moves.");
...
static const u8 sVaporizeDescription[] = _("Water moves always fail.");
static const u8 sAmplifyDescription[] = _("Boosts sound moves.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_VAPORIZE] = sVaporizeDescription,
